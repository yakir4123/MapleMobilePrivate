...
public class EquipData extends ItemData {
    ...
    private EnumMap<PlayerStatsViewModel.Id, Short> reqStats;
    ...
    public EquipData(int id)
    {
        ...
        reqStats = new EnumMap<>(PlayerStatsViewModel.Id.class);
        reqStats.put(PlayerStatsViewModel.Id.LEVEL, src.getChild("reqLevel").get(0L).shortValue());
        reqStats.put(PlayerStatsViewModel.Id.JOB, src.getChild("reqJob").get(0L).shortValue());
        reqStats.put(PlayerStatsViewModel.Id.STR, src.getChild("reqSTR").get(0L).shortValue());
        reqStats.put(PlayerStatsViewModel.Id.DEX, src.getChild("reqDEX").get(0L).shortValue());
        reqStats.put(PlayerStatsViewModel.Id.INT, src.getChild("reqINT").get(0L).shortValue());
        reqStats.put(PlayerStatsViewModel.Id.LUK, src.getChild("reqLUK").get(0L).shortValue());
    ...
    public int getRequirment(PlayerStatsViewModel.Id requirement_stat) {
        try {
